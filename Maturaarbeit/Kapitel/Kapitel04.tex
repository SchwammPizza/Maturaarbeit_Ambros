...
\caption[Das Buddhabrot der Quadranten (eigenes Bild)]{Das Buddhabrot der einzelnen Quadranten}
...
\begin{figure}[h!]
	...
	\caption[Der Verwerfungsbereich (eigenes Bild)]{Das Buddhabrot für $\{z \in \mathbb{C}| |z|>1\}$ in den Quadranten 1 \& 4}
	\label{fig:absolute}
\end{figure}
Bei Abbildung \ref{fig:absolute} ist der auf einem Pixel maximal erreichte Wert 4.
